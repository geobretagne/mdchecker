...
class MdUnitTestInspireKeyword(Inspirobot.MdUnitTest):
    ...
    def set(self):
        ...
        self.xpath = {
            'inspire': u"/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords[gmd:thesaurusName/gmd:CI_Citation/gmd:title/gco:CharacterString/text()='GEMET - INSPIRE themes, version 1.0']",
...
class MdUnitTestLicence(Inspirobot.MdUnitTest):
    ...
    def set(self):
        self.name=u'LIC'
        self.abstract=u"""Licence et droits. Vérifie si le mot clef opendata est présent; présence de contraintes légales; limitations d'usage dépassant 25 caractères."""
        self.xpath = {
            'opendata': u"/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword/gco:CharacterString[text()='données ouvertes']",
            'uselimitation': u"/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceConstraints/gmd:MD_LegalConstraints/gmd:useLimitation/gco:CharacterString/text()",
            'restrictions': u"/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceConstraints/gmd:MD_LegalConstraints/gmd:accessConstraints/gmd:MD_RestrictionCode/@codeListValue",
            'constraints': u"""/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceConstraints/gmd:MD_LegalConstraints/gmd:otherConstraints/gco:CharacterString[text()!="Pas de restriction d'accès public"]"""
        }
